...
setuptools.setup(
    ...
    description="基于ChatGPT的企业微信聊天应用，通过 [OpenAI](https://github.com/openai/openai-quickstart-python) 接口生成对话内容，使用 [wechatpy](https://github.com/wechatpy/wechatpy) 实现企业微信应用号消息的接收和回复.",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/chatgpt-on-wecom",  # 模块github地址
